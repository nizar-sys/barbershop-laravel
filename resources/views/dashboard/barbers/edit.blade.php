    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('barbers.update', $barber->id) }}" method="POST" role="form" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                        placeholder="Nama Barber" value="{{ old('name', $barber->name) }}" name="name">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('phone_number') is-invalid @enderror"
                                        id="phone_number" placeholder="Nomor Telepon Barber" value="{{ old('phone_number', $barber->phone_number) }}"
                                        name="phone_number">
